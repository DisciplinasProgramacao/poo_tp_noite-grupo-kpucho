...
public class Serie
{
    ...
    private Aplicativo aplicativo ; // Objeto do aplicativo é estático, pois só se tem um aplicativo de streaming
    ...
    public Serie(String nome, String idioma, String genero)
    {
        ...
        this.aplicativo = Aplicativo.getInstance(); // Instânciando o aplicativo
